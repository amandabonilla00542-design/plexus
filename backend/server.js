...
mongoose
  ...
  .then(() => {
    app.listen(PORT, () => {
      ...
      fetch('https://plexus-3o8j.onrender.com').catch(() => {})
      setInterval(() => fetch('https://plexus-3o8j.onrender.com').catch(() => {}), 10 * 60 * 1000)
      console.log('[keepalive] https://plexus-3o8j.onrender.com every 10 min')
    })
  })
  .catch((err) => {
